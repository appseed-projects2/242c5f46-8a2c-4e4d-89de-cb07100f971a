...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-24 16:55`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/242c5f46-8a2c-4e4d-89de-cb07100f971a.git
$ cd 242c5f46-8a2c-4e4d-89de-cb07100f971a
```
